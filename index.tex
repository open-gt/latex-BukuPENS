...
\include{_internals/judulDalam}
\ifodd\thechapterpagecount\include{_internals/kosong}\fi
...
\include{src/00-front/pernyataanOrisinalitas}
\ifodd\thechapterpagecount\include{_internals/kosong}\fi
...
\include{src/00-front/pengesahanTA}
...
\include{src/00-front/kataPengantar}
\ifodd\thechapterpagecount\include{_internals/kosong}\fi
...
%
\addChapter{Abstrak}
\include{src/00-front/abstrak}
\include{src/00-front/abstract}
